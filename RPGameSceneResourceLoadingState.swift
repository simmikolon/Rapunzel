//
//  RPGameSceneResourceLoadingState.swift
//  Rapunzel
//
...
class RPGameSceneResourceLoadingState: RPGameSceneState {
    ...
    private func loadResources() {
        ...
        loadSceneOperation.completionBlock = { [unowned self] in
            ...
            dispatch_async(dispatch_get_main_queue()) {
                ...
                let didEnterReadyState = self.gameScene.stateMachine.enterState(RPGameSceneCreateLevelEntityState.self)
