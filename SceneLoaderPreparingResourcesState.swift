...
class SceneLoaderPreparingResourcesState: GKState {
    ...
    */
    fileprivate func loadResourcesAsynchronously() {
    ...
    func cancel() {
        ...
        DispatchQueue.main.async {
            ...
            NotificationCenter.default.post(name: Notification.Name(rawValue: SceneLoaderDidFailNotification), object: self.sceneLoader)
        }
    }
}
